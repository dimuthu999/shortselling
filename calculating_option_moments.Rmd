  ...
  for(date in dates) {
    ...
    for(maturity in c(30,90,180)){
      ...
      if(is.finite(lb) & is.finite(ub)) {
        ...
        im_vol_data[paste("C_iv",maturity,sep="_")] <- im_vol_data[paste("C",lb,sep="_")] + ((im_vol_data[paste("C",ub,sep="_")]-im_vol_data[paste("C",lb,sep="_")])/(ub-lb))
        im_vol_data[paste("P_iv",maturity,sep="_")] <- im_vol_data[paste("P",lb,sep="_")] + ((im_vol_data[paste("P",ub,sep="_")]-im_vol_data[paste("C",lb,sep="_")])/(ub-lb))
